...
import {gradosDeColegio,ordernarAscDsc, sectionByGrade,regiones  } from '@/fuctions/regiones'
    ...
    <div className={styles.container}>
      ...
      <div className={styles.filterContainer}>
        <select 
          ...
          name='grado'
        >
          <option value="">Seleccionr region</option>
...
ReporteCurricular.Auth = PrivateRouteEspecialista