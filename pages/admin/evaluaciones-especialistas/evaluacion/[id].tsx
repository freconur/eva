			...
			<div className='grid relative xxl:flex gap-[20px] justify-between p-20 bg-headerPsicolinguistica overflow-hidden'>
				...
				<div className='grid gap-[5px]'>
					...
					<div className='relative z-[100] flex gap-5'>
						...
						{
							dataDirector.dni ?
								<Link href={`reporte-especialista-individual?idEvaluacion=${router.query.id}&idDirector=${dataDirector.dni}`} className='p-1  border-[1px] h-[50px] border-green-500 rounded-sm drop-shadow-xl'>
