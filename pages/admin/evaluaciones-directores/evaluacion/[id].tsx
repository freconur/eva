		...
		<div>
			...
			<div className='grid relative xxl:flex gap-[20px] justify-between p-20 bg-headerPsicolinguistica overflow-hidden'>
				...
				<div className='grid gap-[5px]'>
					<h1 className="text-textTitulos relative z-[20]  text-3xl font-bold font-martianMono text-left">Evaluación {dataEvaluacionDocente?.name?.toLocaleLowerCase()}</h1>
					<div className='relative z-[100] flex gap-5'>
						...
						{
							dataDirector.dni ?
								<Link href={`reporte-director-individual?idEvaluacion=${router.query.id}&idDirector=${dataDirector.dni}`} className='p-1  border-[1px] h-[50px] border-green-500 rounded-sm drop-shadow-xl'>
				...
				<div className='flex gap-2'>
					...
					<button onClick={handleShowEvaluarDocente} className='h-[50px] relative z-[30] p-3 bg-gradient-to-r from-amarilloLogo to-tableEstandares4  text-textTitulos  rounded-sm drop-shadow-lg '>Evaluar director</button>
