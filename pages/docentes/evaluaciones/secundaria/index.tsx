  ...
  return (
    <div className='bg-gradient-to-r  h-full p-10'>
      <div className='w-[960px] grid m-auto'>
        <h1 className='text-3xl font-bold font-martianMono uppercase text-white text-center mb-10'>educación secundaria</h1>
        <div className='grid grid-cols-3'>
          <div className='grid grid-rows-nivelPrimaria drop-shadow-lg overflow-hidden rounded-md w-[300px]'>
            <div className=' bg-tableEstandares3 grid items-center justify-center relative'>
              <div className='absolute z-[50] top-[-30px] right-[105px] m-auto'>
                <p className='font-martianMono font-semibold text-[140px] text-white opacity-50 '>7</p>
              </div>
              <h2 className='text-3xl text-textTitulos  font-bold text-center'>Estándar de aprendizaje</h2>
            </div>
            <Link href="secundaria/pruebas?grado=10&categoria=1" className='cursor-pointer bg-tableSec2 h-[100px] relative  grid justify-center items-center hover:opacity-90'>
              ...
              <p className='relative z-[40] text-2xl text-center capitalize font-montserrat font-bold text-white'>4to sec.: lee</p>
            </Link>
            <Link href="secundaria/pruebas?grado=10&categoria=2" className='cursor-pointer bg-tableSec3 h-[100px] relative  grid justify-center items-center hover:opacity-90'>
              <div className='absolute top-0 bottom-0 left-0 right-0 bg-slate-700 opacity-20 z-[30]'></div>
              <div className='absolute top-[24px] overflow-hidden right-[100px] z-[20]'>
                <Image
                  alt="logo formativa"
              ...
              <p className='relative z-[40] text-2xl capitalize text-center font-montserrat font-bold text-white'>4to sec.: resuelve problemas</p>
            </Link>
            <Link href="secundaria/pruebas?grado=11&categoria=1" className='cursor-pointer bg-tableSec4 h-[100px] relative  grid justify-center items-center hover:opacity-90'>
              <div className='absolute top-0 bottom-0 left-0 right-0 bg-slate-700 opacity-20 z-[30]'></div>
              <div className='absolute top-[24px] overflow-hidden right-[100px] z-[20]'>
                <Image
                  alt="logo formativa"
              ...
              <p className='relative z-[40] text-2xl capitalize font-montserrat font-bold text-white'>5to sec.: lee</p>
            </Link>
            <Link href="secundaria/pruebas?grado=11&categoria=2" className='cursor-pointer bg-tableSec5 h-[100px] relative  grid justify-center items-center hover:opacity-90'>
              <div className='absolute top-0 bottom-0 left-0 right-0 bg-slate-700 opacity-20 z-[30]'></div>
              <div className='absolute top-[24px] overflow-hidden right-[100px] z-[20]'>
                <Image
                  alt="logo formativa"
              ...
              <p className='relative z-[40] text-2xl capitalize text-center font-montserrat font-bold text-white'>5to sec.: resuelve problemas</p>
            </Link>
          </div>
