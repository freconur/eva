...
const ReporteDocenteIndividual = () => {
  ...
  const { buscarDocenteReporteDeEvaluacion, getDataEvaluacionMediacionDirector, buscarDocenteReporteEvaluacionToEspecilista } = UseEvaluacionDocentes()
  ...
  useEffect(() => {
    if (route.query.idEvaluacion && route.query.idDocente) {
      buscarDocenteReporteEvaluacionToEspecilista(`${route.query.idEvaluacion}`, dataDocente)
      getDocente(`${route.query.idDocente}`)
      getDataEvaluacionMediacionDirector(`${route.query.idEvaluacion}`)
    }
  }, [`${route.query.idEvaluacion}`, `${route.query.idDocente}`, dataDocente.dni])
