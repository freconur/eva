...
import TablaMaestroUsuarios from '@/components/curricular/tablas/tablaMaestroUsuarios'
            ...
            <div className={styles.tableContainer}>
              <TablasEvaluacionesDirectores evaluacionCurricular={evaluacionCurricular} />
              {
                currentUserData.rol === 4 ?
                  null
                  :
                  <TablaMaestroUsuarios rol={2} docentesDeDirectores={docentesDeDirectores} />
              }
            </div>
          </>
      }
