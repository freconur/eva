...
const Reportes = () => {
  ...
  const { reporteTablaEvaluacionEspecialista,getPreguntasRespuestasEspecialistas, getDataEvaluacion, getPREspecialistaDirector } = UseEvaluacionEspecialistas()
                ...
                <div className={styles.filtersContainer}>
                  ...
                  <div>
                    ...
                    >
                      ...
                      {distritosPuno.find(distrito => Number(distrito.id) === Number(currentUserData?.region))?.distritos.map((distrito, index) => (
