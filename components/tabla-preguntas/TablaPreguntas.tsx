  ...
  return (
    <>
      <div className={`${className}`}>
        ...
        {/* Controles de paginación - Fuera del contenedor con scroll horizontal */}
        {!warningEvaEstudianteSinRegistro && paginationData.totalPages > 1 && (
          <div className={styles.paginationContainer}>
            ...
            <div className={styles.paginationControls}>
              ...
              <button
                className={`${styles.paginationButton} ${currentPage === paginationData.totalPages ? styles.disabled : ''}`}
                onClick={() => handlePageChange(currentPage + 1)}
